...
class PHPExcel_Shared_OLERead {
    ...
    private $numBigBlockDepotBlocks      = 0;
    private $numExtensionBlocks          = 0;
    private $bigBlockChain               = 0;
    private $smallBlockChain             = 0;
    private $rootStartBlock              = 0;
    private $sbdStartBlock               = 0;
    private $props                       = array();
    private $rootentry                   = array();
    private $entry                       = "";
	...
	public function read($sFileName)
	{
        ...
        $extensionBlock = 0;
        $extensionBlock = self::_GetInt4d($this->data, self::EXTENSION_BLOCK_POS);
		...
		for ($j = 0; $j < $this->numExtensionBlocks; ++$j) {
			...
			if ($bbdBlocks < $this->numBigBlockDepotBlocks) {
				$extensionBlock = self::_GetInt4d($this->data, $pos);
			}
		}
